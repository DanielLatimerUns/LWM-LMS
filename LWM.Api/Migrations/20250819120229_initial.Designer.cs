...
namespace LWM.Api.Migrations
{
    ...
    [Migration("20250819120229_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LWM.Data.Models.ScheduleInstance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LWM.Data.Models.ScheduleItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LWM.Data.Models.TimeTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LWM.Data.Models.TimeTableDay", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TimeTableDay");
                });

            modelBuilder.Entity("LWM.Data.Models.TimeTableEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LWM.Data.Models.ScheduleInstance", b =>
                {
                    ...
                    b.HasOne("LWM.Data.Models.ScheduleItem", "ScheduleItem")
                        .WithMany()
            ...
            modelBuilder.Entity("LWM.Data.Models.ScheduleItem", b =>
                {
                    ...
                    b.HasOne("LWM.Data.Models.TimeTableEntry", "TimeTableEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("LWM.Data.Models.TimeTableDay", b =>
                {
                    b.HasOne("LWM.Data.Models.TimeTable", "TimeTable")
                        .WithMany()
            ...
            modelBuilder.Entity("LWM.Data.Models.TimeTableEntry", b =>
                {
                    ...
                    b.HasOne("LWM.Data.Models.TimeTableDay", "TimeTableDay")
                        .WithMany()
