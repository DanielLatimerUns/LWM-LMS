...
namespace LWM.Api.DomainServices.Lesson
{
    public class LessonWriteService : ILessonWriteService
    {
        ...
        public async Task<int> CreateAsync(Dtos.Models.LessonModel lesson, AzureObjectLink? azureObjectLink = null)
        {
            var curricullum = 
                _context.LessonCurriculums.FirstOrDefault(x => x.Id == lesson.CurriculumId);
            ...
            var model = new Data.Models.Lesson.Lesson
            {
                Name = lesson.Name,
        ...
        public async Task UpdateAsync(Dtos.Models.LessonModel lesson)
        {
        ...
        private void Validate(Data.Models.Lesson.Lesson lesson)
        {
            if (lesson is null)
